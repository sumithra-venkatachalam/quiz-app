...
function DomainListing() {
    ...
    const filteredData = mockData.filter((item) =>
        item?.domainName?.toLowerCase()?.includes(searchText?.toLowerCase())
      );

    const allDomains= filteredData?.map(x=> (
    ...
    return(
        <div>
            ...
            <div className="headerBelow">
                ...
                <input value={searchText} onChange={handleSearchBar} className="search" type="text" placeholder="Search our quiz domains" />
                </div>
